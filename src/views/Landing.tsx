...
export function Landing() {
  ...
  return (
    <section className={`vh-100 vw-100 hero-section text-bg-${theme}`}>
           ...
           <div className="row align-items-center">
               <div className="col-lg-6 hero-content">
                   ...
                   <div className="hero-buttons">
                       ...
                       <Link to="/dashboard" className="btn btn-outline mb-2">Watch Demo <i className="fas fa-play ms-2"></i></Link>
                   </div>
